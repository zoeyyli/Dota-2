...
- net_worth (categorical variable): total amount of resources used by the player during the match\
...
plot(asdf, pch = 16, cex = 0.3, main = 'Scatterplot Matrix for Dota2 Dataset')
```
