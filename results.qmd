...
ggplot(dota2, aes(net_worth))+
  ...
  theme_grey(9)
```
For the four abilities "omniknight_hammer_of_purity", "death_prophet_exorcism", "lina_fiery_soul", and "tusk_snowball", we can see all four of them are in reasonably fine economic standing, with "death_prophet_exorcism" having extremely high net worth compared to all abilities. This can help confirm that the four abilities selected have good economic standing. 
