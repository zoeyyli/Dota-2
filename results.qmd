...
```
From this graph, we can see for what heroes tend to have higher win rate, which also affect the strength of abilites which will be further analyzed below. 
